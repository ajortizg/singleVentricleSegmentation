...
if __name__ == "__main__":
    ...
    train_ds = SingleVentricleDataset(config, DatasetMode.TRAIN, load_flow=False, img4d_transforms=img4d_transf, mask_transforms=mask_transf)
    val_ds = SingleVentricleDataset(config, DatasetMode.VAL, load_flow=False, img4d_transforms=img4d_transf, mask_transforms=mask_transf)
