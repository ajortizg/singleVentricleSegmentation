...
from scripts.preprocessing.dataset import MRIBaseDataset, Patient
...
def main(config_dir='conf', config_name='preprocessing.yaml'):
    """
    ...
    save_dir = path_utils.create_save_dir(cfg.data.out_dir, "preprocessing_cut")
