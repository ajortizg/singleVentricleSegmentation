...
run_optical_flow() {
  ...
  echo "Started $mode flow with indices $indices on GPU $gpu, logging to $log_file. Process ID: $!"

  # Delay of 2 seconds to avoid same output folder names
  sleep 2
}
...
run_optical_flow "backward" "(25,50)" 0 "results/bwd_25-50.log"
run_optical_flow "backward" "(50,75)" 1 "results/bwd_50-75.log"
