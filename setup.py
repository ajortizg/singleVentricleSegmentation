...
setup(
    ...
    ext_modules=[
        CUDAExtension('opticalFlow',
            sources=['src/bindings.cpp', 'src/differentialOps.cu', 'src/anisotropicDifferentialOps.cu', 'src/warpingOps.cu', 'src/prolongationOps.cu', 'src/opticalFlowOps.cu', 'src/ROFOps.cu'],
            runtime_library_dirs = library_dirs,
            extra_compile_args={'cxx': [], 'nvcc': ['-O3']}),
    ],
    cmdclass={
