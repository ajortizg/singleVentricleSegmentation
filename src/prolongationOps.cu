  ...
  const InterpolationType interpolation, const BoundaryType boundary )
{
  ...
  auto u_prolongated = torch::zeros({NY_Prolong,NX_Prolong,2}, u.options());
  ...
  const InterpolationType interpolation, const BoundaryType boundary )
{
  ...
  auto u_prolongated = torch::zeros({NY_Prolong,NX_Prolong,2,2}, u.options());
  ...
  const InterpolationType interpolation, const BoundaryType boundary )
{
  ...
  auto u_prolongated = torch::zeros({NZ_Prolong,NY_Prolong,NX_Prolong,3}, u.options());
  ...
  const InterpolationType interpolation, const BoundaryType boundary )
{
  ...
  auto u_prolongated = torch::zeros({NZ_Prolong,NY_Prolong,NX_Prolong,3,3}, u.options());
