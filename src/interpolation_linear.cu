...
//REFLECTION Boundary
//__device__ int cuda_interpolate1d_linear_getIndex_bdryReflect( 
//       const int ix_in,
//       const int N) {
//
//  int ix_out; 
...
//
//  T u_f = 0;
//  const int ix_f_out = cuda_interpolate1d_linear_getIndex_bdryReflect(ix_f,NX);  
//  u_f = u[ix_out];
//
//  T u_c = 0;
//  const int ix_c_out = cuda_interpolate1d_linear_getIndex_bdryReflect(ix_c,NX);  
//  u_c = u[ix_out];
//
//  T out = (1 - wx) * u_f;
//  out += wx * u_c;
