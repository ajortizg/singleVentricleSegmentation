"""
Adapted from: https://github.com/facebookresearch/fastMRI/blob/main/fastmri/models/unet.py
"""
...
class Unet(nn.Module):
    ...
    def __init__(self, config, logger
        ...
        self.in_chans = config.getint('PARAMETERS', 'INPUT_CHANNELS')
        self.out_chans = config.getint('PARAMETERS', 'NUM_CLASSES')
        self.chans = config.getint('PARAMETERS', 'FEATURES_START')
